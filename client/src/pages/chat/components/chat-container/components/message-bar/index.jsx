...
const MessageBar = () => {
  ...
  const handleSendMessage = async () => {
    if (selectedChatType === "contact") {
      ...
      socket.emit("send-channel-messsage", {
        sender: userInfo.id,
        content: message,
        messageType: "text",
        fileUrl: undefined,
  ...
  return (
    <div className="h-[10vh] bg-[#1c1d25] flex justify-center items-center gap-6 px-8 mb-6">
      ...
      <button
        className="bg-[#8417ff] rounded-md items-center justify-center p-5 gap-2 focus:border-none hover:bg-[#741bda]     focus:bg-[#741bda] focus:outline-none focus:text-white duration-300 transition-all"
